...
<?php require 'php_action/name_action.php';?>				

<li class="light-blue dropdown-modal">
<a data-toggle="dropdown" href="#" class="dropdown-toggle">
	<img class="nav-user-photo" src="assets/images/avatars/avatar2.png" alt="Jason's Photo" />
	<span class="user-info">
	<small>Welcome,</small><?php echo $data['user_name']?></span>

								<i class="ace-icon fa fa-caret-down"></i>
							</a>

							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close"><li>
									<a href="profile.php">
				...
				<ul class="nav nav-list">
					...
					<li class="">
					  <a href="vehicle.php" >
							...
							<span class="menu-text">Vehicle's Info </span>
                            <b class="arrow"></b>
					  </a>
					</li>
					<li class="">
					  <a href="logging.php">
							...
							<span class="menu-text"> Logging's Info </span>
					  </a><b class="arrow"></b>
				  </li>
				</li>
				</ul>
